...
class EngineRunner:
    ...
    def run(self, site_filter=None, candidate_data=None):
        ...
        Args:
            ...
            candidate_data (dict, optional): Candidate parameters from database
        """
        logger.info("=" * 60)
    ...
    def _process_site(self, session, site: JobSite, candidate_data=None):
        ...
        Args:
            ...
            candidate_data: Candidate profile data (optional)
        """
        logger.info("\n" + "-" * 60)
        ...
        try:
            ...
            if getattr(strategy, 'use_single_phase', False):
                # Sites like LanceSoft use apply-immediately strategy
